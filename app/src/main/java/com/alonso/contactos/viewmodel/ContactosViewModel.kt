package com.alonso.contactos.viewmodel
...
import com.alonso.contactos.database.ContactosDatabase
import com.alonso.contactos.model.*
import com.alonso.contactos.repository.ContactosRepository
...
class ContactosViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val contactosFiltrados: LiveData<List<Contacto>> = _busqueda.switchMap {
