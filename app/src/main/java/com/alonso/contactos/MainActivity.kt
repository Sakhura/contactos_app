...
import com.alonso.contactos.adapter.ContactosAdapter
import com.alonso.contactos.databinding.ActivityMainBinding
import com.alonso.contactos.model.Contacto
import com.alonso.contactos.viewmodel.ContactosViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    private fun abrirGestionarGrupos() {
        ...
        Toast.makeText(this, "Gestión de grupos - No hecho :c", Toast.LENGTH_SHORT).show()
    }

    private fun exportarContactos() {
        viewModel.contactos.value?.let { contactos ->
            if (contactos.isNotEmpty()) {
                Toast.makeText(this, "Exportando ${contactos.size} contactos... - No hecho :c", Toast.LENGTH_SHORT).show()
                // BackupUtils.exportar(this, contactos)
            } else {
                Toast.makeText(this, "No hay contactos para exportar - No hecho :c", Toast.LENGTH_SHORT).show()
            }
        }
    }
    ...
    private fun importarContactos() {
        ...
        Toast.makeText(this, "Importar contactos - No hecho :c", Toast.LENGTH_SHORT).show()
    }
